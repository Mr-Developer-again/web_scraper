...
email = sing_in.find_element(By.XPATH , '//div[contains(@class, "n") and contains(@class, "o") and contains(@class, "p") and contains(@class, "jc") and contains(@class, "mo") and contains(@class, "mp") and contains(@class, "mq") and contains(@class, "mr") and contains(@class, "ms") and contains(@class, "an") and contains(@class, "ao") and contains(@class, "ip") and contains(@class, "ap") and contains(@class, "aq") and contains(@class, "mt")]')
button = email.find_element(By.TAG_NAME, 'button')
button.click()
sleep(2)
input_eamil = email.find_element(By.TAG_NAME , 'input')
input_eamil.send_keys("babaknasrollahy@gmail.com")
sleep(2)
click_on_continue = email.find_element(By.TAG_NAME , 'button')
